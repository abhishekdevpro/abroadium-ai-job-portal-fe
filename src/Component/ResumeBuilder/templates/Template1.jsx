    ...
    >
      {sections.map((section, index) => (
        <div
          ...
          onDrop={(e) => handleDrop(e, index)}
          onDragOver={handleDragOver}
          // className="mb-6 p-4 rounded border-2 border-transparent hover:border-gray-300 hover:bg-gray-50 transition-all duration-300 ease-in-out cursor-move relative group"
          className="mb-6 pl-10 pr-4 py-4 rounded border-2 border-transparent hover:border-blue-500 hover:bg-gray-50 transition-all duration-300 ease-in-out cursor-move relative group"
